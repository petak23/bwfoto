...
class ClankyPresenter extends \App\EditModule\Presenters\BasePresenter {
	/** 
   * @inject
  ...
  /** @var \App\EditModule\Components\Clanky\IPrilohyClanokControl @inject */
  public $prilohyClanokControlFactory;
  /** @var \App\EditModule\Components\Faktury\IViewFakturyControl @inject */
  public $viewFakturyControlFactory;
  /** @var \App\EditModule\Components\Clanky\ZobrazKartyPodclankov\IZobrazKartyPodclankovControl @inject */
  ...
  public function createComponentUkazTentoClanok() {
    $ukaz_clanok = New \App\EditModule\Components\Clanky\ZobrazClanok\ZobrazClanokControl($this->zobraz_clanok);
   ...
   * @return \App\EditModule\Components\Clanky\PrilohyClanokControl */
  ...
  /** 
   * Komponenta pre zobrazenie priloh
   * @return \App\EditModule\Components\Faktury\ViewFakturyControl */
   ...
   * @return \App\EditModule\Components\Clanky\ZobrazKartyPodclankov\ZobrazKartyPodclankovControl */
