...
class VerziePresenter extends BasePresenter
{
   ...
   * @param array $conf_dialog Výstup z potvrdzovacieho dialógu
   * @param string $nazov Text pre hlasenie - cislo verzie */
  function confirmedDelete(array $conf_dialog, string $nazov = ""): void
  {
    $this->flashOut($this->verzie->zmaz($conf_dialog['id']) == 1, 'Verzie:', 'Verzia ' . $nazov . ' bola úspešne vymazaná!', 'Došlo k chybe a verzia ' . $nazov . ' nebola vymazaná!');
  }
