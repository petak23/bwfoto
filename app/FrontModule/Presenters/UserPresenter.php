...
class UserPresenter extends BasePresenter
{
	...
	{
		$this->template->reg_enabled = ($this->udaje->findOneBy(['nazov' => 'registracia_enabled'])->text == 1);
	}
	...
	protected function createComponentClenRegistraciaForm(): Form
	{
	...
	public function userRegisterFormSubmitted(Form $form, $values): void
	{
		...
		if ($uloz_user_main !== FALSE) { //Ulozenie v poriadku
			...
			$this->flashMessage($this->texty_presentera->translate('register_save_err'), 'danger');
