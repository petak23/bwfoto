...
class User_profiles extends Table
{
	 ...
	 * Vráti pole max a sum pocet prihlaseni
	 */
	 ...
	 * Vráti pole emailou s dvoma castami "komu" - retazec emilov oddelených ciarkami; "clen" - arra emailov
	 */
	...
	/** Pre vrátenie profilu užívateľa */
