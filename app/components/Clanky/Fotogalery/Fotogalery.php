...
class FotogaleryControl extends Nette\Application\UI\Control
{
  ...
  /**
   * Nastavenie first_id */
  public function set_first_id(int $first_id = 0): FotogaleryControl
  {
  ...
  public function fromConfig(array $params): FotogaleryControl
  {
  ...
  /**
   * Načítanie príloh */
  public function getAttachments(): FotogaleryControl
  {
    // Výber podčlánkov
...
{
  function create(string $language, Nette\Database\Table\ActiveRow $hlavne_menu): FotogaleryControl;
}
