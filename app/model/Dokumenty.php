...
class Dokumenty extends Table {
  ...
  public function getPrilohy(int $id) {  
   ...
   * @return Nette\Database\Table\Selection|FALSE */
  public function getViditelnePrilohy(int $id, string $order = "pripona ASC") {
   ...
   * @param string $order Sposob zoradenia
   * @return Nette\Database\Table\Selection|FALSE */
  public function getVisibleImages(int $id, string $order = "pripona ASC") {
   ...
   * @param string $order Sposob zoradenia
   * @return Nette\Database\Table\Selection|FALSE */
  public function getVisibleVideos(int $id, string $order = "pripona ASC") {
   ...
   * @param string $order Sposob zoradenia
   * @return Nette\Database\Table\Selection|FALSE */
  public function getVisibleAudios(int $id, string $order = "pripona ASC") {
   ...
   * @return Nette\Database\Table\Selection|FALSE */
  public function getVisibleOther(int $id, string $order = "pripona ASC") {
  ...
  public function ulozPrilohu(array $data, $id) {
